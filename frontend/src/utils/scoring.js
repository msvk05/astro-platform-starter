...
const getDetailedInsights = (primaryCategory, secondaryCategory, language = 'en') => {
  ...
  // Translate superhero and work style descriptions based on language
  if (language !== 'en') {
    const translations = getDetailedTranslations(language);
    const categoryTranslations = translations[primaryCategory];
    
    if (categoryTranslations) {
      return {
        workStyle: categoryTranslations.workStyle || profile.workStyle,
        careerPaths: categoryTranslations.careerPaths || profile.careerPaths,
        growthAreas: categoryTranslations.growthAreas || profile.growthAreas,
        superhero: categoryTranslations.superhero || profile.superhero
      };
    }
  }
...
// Translation overlay for Hindi and Telugu
const getDetailedTranslations = (language) => {
  const translations = {
    hi: {
      structure: {
        workStyle: {
          environment: 'स्पष्ट प्रणालियों और दिनचर्या के साथ संगठित कार्यस्थल',
          schedule: 'नियोजित ब्रेक के साथ निश्चित कार्यक्रम पसंद करते हैं',
          collaboration: 'परिभाषित भूमिकाओं के साथ संरचित टीमों में अच्छा काम करते हैं',
          tools: 'प्लानर, चेकलिस्ट, प्रोजेक्ट मैनेजमेंट टूल्स पसंद हैं'
        },
        careerPaths: [
          'प्रोजेक्ट मैनेजर',
          'ऑपरेशंस कोऑर्डिनेटर',
        ...
        growthAreas: [
          {
            area: 'लचीलापन अपनाएं',
            tip: 'हर हफ्ते एक अनियोजित गतिविधि के लिए "हाँ" कहने का अभ्यास करें',
            why: 'जीवन हमेशा योजनाओं का पालन नहीं करता - अनुकूलन क्षमता एक महाशक्ति है'
          },
          {
            area: 'रचनात्मक सोच',
            tip: 'विचारों को आंके बिना साप्ताहिक 15 मिनट विचार-मंथन में बिताएं',
            why: 'संरचना + रचनात्मकता = नवाचार'
          },
          {
            area: 'प्रत्यायोजन',
            tip: 'दूसरों को अपने तरीके से कार्य पूरा करने दें, भले ही वह आपसे अलग हो',
            why: 'विश्वास नियंत्रण से अधिक मजबूत टीमें बनाता है'
          }
        ],
        superhero: {
          name: 'योजनाकार',
          power: 'अराजकता को व्यवस्था में बदलता है',
          motto: 'हर चीज के लिए एक स्थान, और हर चीज अपनी जगह पर',
          strength: 'आप ऐसी प्रणालियां बनाते हैं जिनका दूसरे अनुसरण कर सकें'
        }
      },
      empathy: {
        workStyle: {
          environment: 'सहायक, मनोवैज्ञानिक रूप से सुरक्षित स्थान',
          schedule: 'भावनात्मक प्रसंस्करण के लिए ब्रेक की आवश्यकता',
          collaboration: 'मेंटरिंग, परामर्श, टीम सामंजस्य में उत्कृष्ट',
          tools: 'एक-के-बाद-एक बैठकें, फीडबैक सत्र, सपोर्ट ग्रुप'
        },
        careerPaths: [
          ...
          'ग्राहक सफलता',
          'एनजीओ/गैर-लाभकारी कार्य',
          'एचआर विशेषज्ञ'
        ],
        growthAreas: [
          {
            area: 'सीमाएं',
            tip: 'बिना अपराध बोध के "मुझे रिचार्ज होने का समय चाहिए" का अभ्यास करें',
            why: 'अपनी देखभाल करना दूसरों की देखभाल करने में सक्षम बनाता है'
          },
          {
            area: 'सीधी प्रतिक्रिया',
            tip: 'साप्ताहिक एक ईमानदार आलोचना साझा करें (दयालुता से)',
            why: 'सच्चा समर्थन कभी-कभी कठिन बातचीत का मतलब है'
          },
          {
            area: 'वस्तुनिष्ठता',
            tip: 'संघर्षों में, भावनाओं से पहले तथ्यों की सूची बनाएं',
            why: 'बेहतर निर्णयों के लिए हृदय को सिर के साथ संतुलित करें'
          }
        ],
        superhero: {
          name: 'समर्थक',
          power: 'दूसरों की भावनाओं को महसूस करता है',
          motto: 'मैं तुम्हें देखता हूं, मैं तुम्हें सुनता हूं',
          strength: 'आप सुरक्षित स्थान बनाते हैं जहां लोग कमजोर हो सकते हैं'
        }
      },
      responsibility: {
        workStyle: {
          environment: 'विश्वास-आधारित संस्कृतियां जो सत्यनिष्ठा को महत्व देती हैं',
          schedule: 'स्व-निर्देशित, अपनी प्रतिबद्धताओं के स्वामी',
          collaboration: 'विश्वसनीय टीम सदस्य, दूसरे उन पर भरोसा करते हैं',
          tools: 'जवाबदेही प्रणाली, चिंतन पत्रिकाएं, फीडबैक लूप'
        },
        careerPaths: [
          'नेतृत्व भूमिकाएं',
          'नैतिकता और अनुपालन',
          ...
          'कानूनी व्यवसाय',
          'गुणवत्ता नियंत्रण',
          'सत्यनिष्ठा को महत्व देने वाला कोई भी क्षेत्र'
        ],
        growthAreas: [
          {
            area: 'आत्म-करुणा',
            tip: 'अपने साथ उतनी ही दयालुता से व्यवहार करें जितना आप दूसरों के साथ करते हैं',
            why: 'आत्म-क्षमा के बिना जिम्मेदारी पक्षाघात की ओर ले जाती है'
          },
          {
            area: 'साझा जवाबदेही',
            tip: 'दूसरों को भी जिम्मेदारी लेने दें',
            why: 'सभी दोष लेने से दूसरों को बढ़ने से रोकता है'
          },
          {
            area: 'जीत मनाएं',
            tip: 'जो सही हुआ उसे स्वीकार करें, न कि केवल जो गलत हुआ',
            why: 'प्रगति को केवल सुधार की नहीं, मान्यता की आवश्यकता है'
          }
        ],
        superhero: {
          name: 'जवाबदेह',
          power: 'अटल सत्यनिष्ठा',
          motto: 'इसके स्वामी बनो, इसे ठीक करो, इससे बढ़ो',
          strength: 'आप एक ऐसी दुनिया में भरोसेमंद हैं जिसे अधिक विश्वास की आवश्यकता है'
        }
      }
    },
    te: {
      structure: {
        workStyle: {
          environment: 'స్పష్టమైన వ్యవస్థలు మరియు దినచర్యలతో వ్యవస్థీకృత కార్యస్థలం',
          schedule: 'ప్రణాళికాబద్ధమైన విరామాలతో స్థిర షెడ్యూల్‌లను ఇష్టపడతారు',
          collaboration: 'నిర్వచించిన పాత్రలతో నిర్మాణాత్మక బృందాలలో బాగా పనిచేస్తారు',
          tools: 'ప్లానర్లు, చెక్‌లిస్ట్‌లు, ప్రాజెక్ట్ నిర్వహణ సాధనాలను ఇష్టపడతారు'
        },
        careerPaths: [
          'ప్రాజెక్ట్ మేనేజర్',
        ...
        growthAreas: [
          {
            area: 'సౌకర్యవంతత స్వీకరించండి',
            tip: 'ప్రతి వారం ఒక ప్రణాళిక లేని కార్యకలాపానికి "అవును" అని చెప్పడం అభ్యసించండి',
            why: 'జీవితం ఎల్లప్పుడూ ప్రణాళికలను అనుసరించదు - అనుకూలత ఒక మహాశక్తి'
          },
          {
            area: 'సృజనాత్మక ఆలోచన',
            tip: 'ఆలోచనలను తీర్పు చెప్పకుండా వారానికి 15 నిమిషాలు బ్రెయిన్‌స్టార్మింగ్‌లో గడపండి',
            why: 'నిర్మాణం + సృజనాత్మకత = ఆవిష్కరణ'
          },
          {
            area: 'ప్రతినిధి అప్పగించడం',
            tip: 'ఇతరులను వారి మార్గంలో పనులు పూర్తి చేయడానికి అనుమతించండి, అది మీకు భిన్నంగా ఉన్నా',
            why: 'నమ్మకం నియంత్రణ కంటే బలమైన బృందాలను నిర్మిస్తుంది'
          }
        ],
        superhero: {
          name: 'ప్లానర్',
          power: 'గందరగోళాన్ని క్రమంలోకి మారుస్తుంది',
          motto: 'ప్రతిదానికి ఒక స్థలం, మరియు ప్రతిదీ దాని స్థలంలో',
          strength: 'మీరు ఇతరులు అనుసరించగల వ్యవస్థలను నిర్మిస్తారు'
        }
      },
      empathy: {
        workStyle: {
          environment: 'మద్దతు ఇచ్చే, మానసికంగా సురక్షితమైన స్థలాలు',
          schedule: 'భావోద్వేగ ప్రాసెసింగ్ కోసం విరామాలు అవసరం',
          collaboration: 'మెంటరింగ్, కౌన్సెలింగ్, టీమ్ సామరస్యంలో అద్భుతం',
          tools: 'ఒకరితో ఒకరు సమావేశాలు, ఫీడ్‌బ్యాక్ సెషన్లు, సపోర్ట్ గ్రూప్‌లు'
        },
        careerPaths: [
          'కౌన్సెలర్/థెరపిస్ట్',
          'సామాజిక కార్యకర్త',
          'ఆరోగ్య సంరక్షణ నిపుణుడు',
          'కస్టమర్ సక్సెస్',
          'ఎన్జీవో/లాభాపేక్షలేని పని',
          'హెచ్ఆర్ స్పెషలిస్ట్'
        ],
        growthAreas: [
          {
            area: 'హద్దులు',
            tip: '"నాకు రీఛార్జ్ అవ్వడానికి సమయం కావాలి" అని అపరాధ భావన లేకుండా అభ్యసించండి',
            why: 'మీ కోసం శ్రద్ధ తీసుకోవడం ఇతరుల కోసం శ్రద్ధ తీసుకోవడానికి వీలు కల్పిస్తుంది'
          },
          {
            area: 'ప్రత్యక్ష ఫీడ్‌బ్యాక్',
            tip: 'వారానికి ఒక నిజాయితీ విమర్శను పంచుకోండి (దయతో)',
            why: 'నిజమైన మద్దతు కొన్నిసార్లు కష్టమైన సంభాషణల అర్థం'
          },
          {
            area: 'వస్తునిష్ఠత',
            tip: 'సంఘర్షణలలో, భావాలకు ముందు వాస్తవాలను జాబితా చేయండి',
            why: 'మెరుగైన నిర్ణయాల కోసం హృదయాన్ని తలతో సమతుల్యం చేయండి'
          }
        ],
        superhero: {
          name: 'మద్దతుదారు',
          power: 'ఇతరులు ఏమి అనుభూతి చెందుతున్నారో అనుభూతి చెందుతుంది',
          motto: 'నేను నిన్ను చూస్తాను, నేను నిన్ను వింటాను',
          strength: 'మీరు ప్రజలు బలహీనంగా ఉండగల సురక్షిత స్థలాలను సృష్టిస్తారు'
        }
      },
      responsibility: {
        workStyle: {
          environment: 'సమగ్రతకు విలువ ఇచ్చే విశ్వాస-ఆధారిత సంస్కృతులు',
          schedule: 'స్వయం-నిర్దేశిత, వారి కట్టుబాట్లను కలిగి ఉంటారు',
          collaboration: 'నమ్మదగిన టీమ్ సభ్యుడు, ఇతరులు వారిపై ఆధారపడతారు',
          tools: 'జవాబుదారీ వ్యవస్థలు, ప్రతిబింబ జర్నల్స్, ఫీడ్‌బ్యాక్ లూప్‌లు'
        },
        careerPaths: [
          'నాయకత్వ పాత్రలు',
          'నైతికత & సమ్మతి',
          ...
          'చట్టపరమైన వృత్తులు',
          'నాణ్యత నియంత్రణ',
          'సమగ్రతకు విలువ ఇచ్చే ఏదైనా రంగం'
        ],
        growthAreas: [
          {
            area: 'స్వీయ-కరుణ',
            tip: 'మీరు ఇతరులతో వ్యవహరించినంత దయతో మీతో వ్యవహరించండి',
            why: 'స్వీయ-క్షమాపణ లేకుండా బాధ్యత పక్షవాతానికి దారితీస్తుంది'
          },
          {
            area: 'భాగస్వామ్య జవాబుదారీతనం',
            tip: 'ఇతరులను కూడా బాధ్యత తీసుకోవడానికి అనుమతించండి',
            why: 'అన్ని నిందలను తీసుకోవడం ఇతరులు పెరగకుండా నిరోధిస్తుంది'
          },
          {
            area: 'విజయాలను జరుపుకోండి',
            tip: 'ఏమి సరిగ్గా జరిగిందో అంగీకరించండి, ఏమి తప్పు జరిగింది మాత్రమే కాదు',
            why: 'పురోగతికి కేవలం దిద్దుబాటు కాకుండా గుర్తింపు అవసరం'
          }
        ],
        superhero: {
          name: 'జవాబుదారీగా ఉండేవారు',
          power: 'అచంచలమైన సమగ్రత',
          motto: 'దాన్ని కలిగి ఉండండి, దాన్ని సరిచేయండి, దాని నుండి ఎదగండి',
          strength: 'మీరు మరింత విశ్వాసం అవసరమయ్యే ప్రపంచంలో నమ్మదగినవారు'
        }
      }
    }
  };
